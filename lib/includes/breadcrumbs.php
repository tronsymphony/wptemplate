...
function dimox_breadcrumbs() {
  ...
  $text['author']  = 'Articles Written by %s'; // text for an author page
  $text['404']   = '404 Not Found'; // text for the 404 page
  $show_current  = 1; // 1 - show current post/page/category title in breadcrumbs, 0 - don't show
  $show_on_home  = 1; // 1 - show breadcrumbs on the homepage, 0 - don't show
  $show_home_link = 1; // 1 - show the 'Home' link, 0 - don't show
  $show_title   = 1; // 1 - show the title for the links, 0 - don't show
  $delimiter   = '  <span class="mx-2">|</span>  '; // delimiter between crumbs
  ...
  if (is_home()) {
    ...
    if ($show_on_home == 1) {
      echo '<div class="crumbs"><a href="' . $home_link . '">' . $text['home'] . '</a>';
    }
